        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 pl-0 pt-70 pr-5">
            <div class="business-item-img">
              <img src="{{ asset('landpage/img/business/business-img.png') }}" class="img-fluid" alt="">
            </div>
          </div>
          <!-- End Col -->
          <!-- Start Col -->
            ...
            <div class="showcase-slider owl-carousel">
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="{{ asset('landpage/img/showcase/01.webp') }}" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        ...
                        <div class="zoom-icon">
                          <a class="lightbox" href="{{ asset('landpage/img/showcase/01.webp') }}"><i class="lni-zoom-in"></i></a>
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="{{ asset('landpage/img/showcase/02.webp') }}" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
                        ...
                        <div class="zoom-icon">
                          <a class="lightbox" href="{{ asset('landpage/img/showcase/02.webp') }}"><i class="lni-zoom-in"></i></a>
                          <a href="#"><i class="lni-link"></i></a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="{{ asset('landpage/img/showcase/03.webp') }}" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
                        ...
                        <div class="zoom-icon">
                          <a class="lightbox" href="{{ asset('landpage/img/showcase/03.webp') }}"><i class="lni-zoom-in"></i></a>
                          <a href="#"><i class="lni-link"></i></a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="{{ asset('landpage/img/showcase/04.webp') }}" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
                        ...
                        <div class="zoom-icon">
                          <a class="lightbox" href="{{ asset('landpage/img/showcase/04.webp') }}"><i class="lni-zoom-in"></i></a>
                          <a href="#"><i class="lni-link"></i></a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="item">
                <div class="screenshot-thumb">
                  <img src="{{ asset('landpage/img/showcase/05.webp') }}" class="img-fluid" alt="" />
                  <div class="hover-content text-center">
                    <div class="fancy-table">
                      <div class="table-cell">
                        <div class="single-text">
                        ...
                        <div class="zoom-icon">
                          <a class="lightbox" href="{{ asset('landpage/img/showcase/05.webp') }}"><i class="lni-zoom-in"></i></a>
                          <a href="#"><i class="lni-link"></i></a>
                        </div>
                      </div>
                    </div>
              ...
              <div class="item">
                <div class="testimonial-item">
                  ...
                  <div class="client-thumb">
                    <img src="{{ asset('landpage/img/testimonial/01.png') }}" alt="">
                  </div>
                </div>
              </div>
              <div class="item">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="{{ asset('landpage/img/team/1.webp') }}" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="{{ asset('landpage/img/team/2.webp') }}" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="{{ asset('landpage/img/team/3.webp') }}" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-3 col-md-6 col-xs-12">
            <div class="single-team">
              <div class="team-thumb">
                <img src="{{ asset('landpage/img/team/4.webp') }}" class="img-fluid" alt="">
              </div>
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{ asset('landpage/img/blog/1.webp') }}" class="img-fluid" alt="">
                </a>             
              </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{ asset('landpage/img/blog/2.webp') }}" class="img-fluid" alt="">
                </a>             
              </div>
              <div class="blog-item-text"> 
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{ asset('landpage/img/blog/3.webp') }}" class="img-fluid" alt="">
                </a>             
              </div>
              <div class="blog-item-text"> 
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-12">
            <div class="contact-img">
              <img src="{{ asset('landpage/img/contact/01.png') }}" class="img-fluid" alt="">
            </div>
          </div>
          <!-- End Col -->
          <!-- Start Col -->
          ...
          <!-- Start Col -->
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-6 col-mb-12">
              ...
              <div class="footer-logo">
               <img src="{{ asset('landpage/img/footer-logo.png') }}" alt="">
              </div>
            </div>
             <!-- End Col -->
              <!-- Start Col -->
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="site-info text-center">
                  <p>Designed and Developed by <a href="/" rel="nofollow">{{ $company }}</a></p>
                </div>              
